...
export async function POST(request: NextRequest) {
  try {
    ...
    await sendEmail({
      ...
      html: `
<div style="font-family: Inter, system-ui, sans-serif; max-width: 580px; margin: 0 auto; padding: 40px 20px; color: #0B1020;">
  ...
  <div style="font-size: 15px; line-height: 1.7; color: #0B1020; white-space: pre-wrap;">${body}</div>
